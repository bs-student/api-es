...
//                            'successTitle'=>"You account has been merged with Google Account.",
                            'successTitle' => "Tu cuenta se ha completado con la del Google.",
                            'successData' => array(
...
//                            'errorDescription'=>"Please Try Again Later",
                            ...
                            'errorTitle' => "Lo siento, no hemos podido completado tus datos con el usuario " . $profile['email'] . " existente.",
                            'errorDescription' => "Por favor inténtalo más tarde",
...
//                        'successDescription'=>"Please Fill Up the Next form to complete registration Process",
                        ...
                        'successTitle' => "Has sido registrado.",
                        'successDescription' => "Por favor completa el siguiente formulario para completar el proceso de registro",
...
//                    'errorDescription'=>"Please Try Again Later",
                        ...
                        'errorTitle' => "Lo siento, no hemos podido regístrate ",
                        'errorDescription' => "Por favor inténtalo más tarde",
                        'errorData' => $userForm)
                    , 400);
            }
...
//                            'successTitle'=>"You account has been merged with Facebook Account.",
                            'successTitle' => "Tu cuenta se ha completado con la del Facebook.",
                            'successData' => array(
                                'username' => $user->getUsername(),
                                'fullName' => $user->getFullName(),
                                'email' => $user->getEmail(),
...
//                    'errorDescription'=>"Please provide different username"
                    ...
                    'errorTitle' => "El usuario ya existe",
                    'errorDescription' => "Por favor selecciona un usuario diferente"
                ), 400);
            }
...
//                    'errorDescription'=>"Please provide different email"
                    ...
                    'errorTitle' => "El email ya existe",
                    'errorDescription' => "Por favor selecciona un email diferente"
                ), 400);
            }
...
//                        'successTitle'=>"Your Registration is Completed",
                        'successTitle' => "Su registro se ha completado",
                        'successData' => array(
                            'username' => $user->getUsername(),
                            'fullName' => $user->getFullName(),
                            'email' => $user->getEmail(),
...
//                        'errorDescription'=>"Please Try Again Later",
                        'errorTitle' => "Lo siento, no se ha podido completar el registro",
                        'errorDescription' => "Por favor inténtalo más tarde",
                        'errorData' => $userForm)
                    , 400);
            }
...
//                'errorTitle'=>"Sorry User was not found"
                'errorTitle' => "Los siento, no se ha encontrado usuario"
            ), 400);
        }
